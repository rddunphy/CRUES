...
discuss algorithms being used for exploration. 
Wall follower - works only on simply connected mazes
Trémaux's algorithm - requires recognition of places already been. finds a path, not shortest path	
...
all paths in the maze will be marked twice. 

\subsection{Shortest Path Finding}\label{litreview/maze/path}
