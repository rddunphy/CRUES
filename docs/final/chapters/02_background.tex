...
proportional to the rate of change of the error. This is shown by \todo{is this equation??}
...
a weighted tree search either can be used to solve the problem~\cite{kanal2012search}. 
