...
the robotic systems to perform even in environments which hinder telemetry, such as
...
unit are used to track the robot's position and orientation as it moves through its environment.
