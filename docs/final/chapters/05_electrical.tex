...
The distances are measured by an \verb|USScan| class. This has a \verb|get
...
Some minor changes were made in the connection of the generic GPIO pins in versions
