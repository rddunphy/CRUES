...
Once soldered, the power distribution board and motor driver board
were continuity tested.

\todo{motor drive system test circiut
...
constant and the result is the acceleration in $ms^{-2}$, and \verb|GYRO
...
\label{table:pin_assignments}}
    \begin{tabular}{ccccc}
        ...
        ELA & Left encoder A         & 23 & 23 & 27 \\
        ELB & Left encoder B         & 19 & 19 & 21 \\
