...
velocity of the robot. This can be integrated to
track the robot's position over time again by performing dead reckoning. The
...
The IMU was be placed as close to the centre of the axis of the robot
