...
chassis from Pololu~\cite{pololuchassis}. This chassis were 
...
distribution and motor driver board was continuity tested and monitored to ensure correct functionality.
...
\begin{figure}[!hbt]
	\centering
	\includegraphics[scale = 0.8]{imupyfig.png}
