...
order to evalutate PID tuning methodoloties ahead of the slower process of tuning
...
designed for differential drive robots and takes a ROS twist message~\cite[geometry\_msgs/Twist.msg]{ROSDocs}, converting this to a motor command for each 
...
>>>>>>> 694b4b5b30e2c92b120320adf3f62eedeb37d616
...
In practice, these values for were found to be inaccurate
