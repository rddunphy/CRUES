...
topics---and loose coupling between modules means that maintenance and testing
of each module can take place independently, and significant changes to the
system can be made without the need for major architectural modifications.
...
\section{Control Modules}\label{soft/ai}
