...
the publish--subscribe model. This is where nodes may publish data on communication channels
...
same time, whilst also being able to send messages to different
