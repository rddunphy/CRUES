...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.3\textwidth]{graphs/bad_ekf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.3\textwidth]{graphs/ekf}
...
\todo[inline]{Is this definitely finished Matt? Maybe a sentence, "this functionality was therefore removed in release builds of the code"}


\todo[inline]{Do we need this? Obviously implementation and testing don't exist do we want to write design?}
