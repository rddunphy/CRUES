...
robot). Like in the previous case, the velocity used in the calculation1 is to be 0
...
abrupt changes in velocity. Figure~\ref{ekf_output/bad} shows the path
calculated by the EKF prior to this change, with obvious improvements shown
in Figure~\ref{ekf_output/good}.
