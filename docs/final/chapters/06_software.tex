...
\begin{figure}[!p]\centering
    ...
    \caption{ROS computation diagram showing interactions of nodes and topics for overall system}\label{fig:rqt_graph}
\end{figure}
\end{landscape}
...
The header created includes the IP address and name of both the sender and the
