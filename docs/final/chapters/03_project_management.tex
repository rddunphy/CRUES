...
\todo[inline]{Add subsection that briefly describes tools used for managing the project (Git, issue tracker, project cam boards, Slack, etc.)}
...
From the DMEM department, Dr Mark Post (now at The University of York)
...
using the objectives and their respective sub-objectives (Section~\ref{introduction/objectives}). The timescales were determined
...
electrical or mechanical issues. Multiple issues arose and  including motors
leaking grease, various power issues and one RPi being shorted and killed
