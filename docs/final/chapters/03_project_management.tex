...
issues were created which team members were able to assign themselves to. These could be viewed on the issues board on Github, where the status of each of these could be easily viewed. If
